...
export const INITIAL_CONTACTS: Contact[] = [
  {
    id: '1007363904',
    name: 'الأدمن 1007363904',
    avatar: '🛡️',
    status: 'online',
    role: 'الأدمن المسؤول عن الشكاوي والاشتراكات ومراقبة الاشياء المسيئة وتقييم البلاغات',
    bio: 'للشكاوي والاشتراكات ومراقبة الاشياء المسيئة 🛡️✨',
    isGroup: false
  },
  {
    id: '139213',
    ...
    avatar: '🛠️',
    status: 'online',
    role: 'الأدمن المسؤول عن الدعم الفني وتفعيل الاشتراكات ومراقبة المحتوى المسيء والرد السريع',
    bio: 'للشكاوي والاشتراكات ومراقبة الاشياء المسيئة وتفعيل الحسابات 🛠️⚙️',
    isGroup: false
  },
  {
    id: '1',
...
export const INITIAL_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    text: 'مرحباً بك! أنا الأدمن المسؤول عن استقبال الشكاوي وإدارة الاشتراكات ومراقبة أي محتوى مسيء. كيف يمكنني مساعدتك اليوم؟ 🛡️',
    timestamp: '12:00 م',
    type: 'text',
    status: 'read'
  },
  {
    id: 'm13',
    senderId: '139213',
    senderName: 'الأدمن 139213',
    text: 'أهلاً بك في نظام الدعم والرقابة والاشتراكات. أرسل استفسارك أو شكواك هنا وسأقوم بمراجعتها وتلبية طلبك فوراً 🛠️',
    timestamp: '12:05 م',
    type: 'text',
    status: 'read'
  }
